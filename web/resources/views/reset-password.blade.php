...
<head>
    ...
    <title>Ganti Kata Sandi - Smart Cane Monitoring System</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <p class="sidebar-desc">Verifikasi Berhasil! Silakan Buat Kata Sandi Baru</p>
        </div>
        ...
        <div class="form-container">
            <div class="card">
                ...
                <div class="title-section">
                    ...
                    <p>Akun terverifikasi. Masukkan kata sandi baru untuk akun Anda.</p>
                </div>
                ...
                <form action="{{ route('password.update') }}" method="POST" style="width: 100%;">
                    ...
                    <div class="form-group">
                        <input type="password" id="password" name="password" class="form-control" placeholder="Kata Sandi Baru" required autocomplete="new-password">
                        <i class="fa-regular fa-lock input-icon"></i>
                        <i class="fa-regular fa-eye-slash toggle-password" onclick="togglePassword('password')"></i>
                    </div>

                    <div class="form-group">
                        <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="Konfirmasi Kata Sandi" required autocomplete="new-password">
                        <i class="fa-regular fa-lock input-icon"></i>
                        <i class="fa-regular fa-eye-slash toggle-password" onclick="togglePassword('password_confirmation')"></i>
                    </div>
